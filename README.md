...
## Esta rama: [DBT-3] — dbt Core, caso T16 (⏳ pendiente de datos reales)
...
Esta rama en particular está reservada para la prueba T16 (enriquecimiento
con catálogo/jerarquía) y está **pendiente de que lleguen datos reales** —
ver
[`dbt_transformaciones/models/_pendiente_dbt3_t16/README.md`](dbt_transformaciones/models/_pendiente_dbt3_t16/README.md)

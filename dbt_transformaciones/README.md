# [DBT-3] dbt_transformaciones — motor genérico de transformaciones

> **Prueba DBT-3** del informe Hito 2 (Evaluación Técnica y Selección de la
> Tecnología de Procesamiento). Reservada para el escenario "T16 —
> catálogos y jerarquías" — **⏳ pendiente de datos reales**, ver
> [`models/_pendiente_dbt3_t16/README.md`](models/_pendiente_dbt3_t16/README.md).
...
> `dbt-2` [DBT-2], `sqlmesh-1` [SM-1], `sqlmesh-2` [SM-2] y `hop-1` [HOP-1]
